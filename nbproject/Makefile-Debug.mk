...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/entrega2: usr/include/SFML/libsfml-window.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/entrega2: usr/include/SFML/libsfml-graphics.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/entrega2: usr/include/SFML/libsfml-system.so
...
${OBJECTDIR}/GameState.o: GameState.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GameState.o GameState.cpp
